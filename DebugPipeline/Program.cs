...
namespace DebugPipeline
{
    ...
    class Program
    {
        ...
        /// </summary>
        private static readonly string ProjectToDebug = Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory(), @"..\..\..\ViewerXNA\ViewerXNAContent\ViewerXNAContent.contentproj"));
